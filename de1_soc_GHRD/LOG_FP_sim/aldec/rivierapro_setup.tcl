...
# ACDS 21.1 842 win32 2024.02.27.10:00:36
# ----------------------------------------
...
# ----------------------------------------
# If LOG_FP is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/LOG_FP_memoryC0_uid134_lnTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/LOG_FP_memoryC0_uid135_lnTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/LOG_FP_memoryC1_uid138_lnTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/LOG_FP_memoryC2_uid142_lnTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/LOG_FP.vo"
}
