...
//scfifo ADD_RAM_OUTPUT_REGISTER="OFF" DEVICE_FAMILY="Cyclone V" LPM_NUMWORDS=1024 LPM_SHOWAHEAD="OFF" LPM_WIDTH=12 LPM_WIDTHU=10 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" USE_EAB="ON" clock data empty q rdreq wrreq INTENDED_DEVICE_FAMILY="Cyclone V"
...
//a_dpfifo ADD_RAM_OUTPUT_REGISTER="OFF" ALLOW_RWCYCLE_WHEN_FULL="OFF" DEVICE_FAMILY="Cyclone V" LPM_NUMWORDS=1024 LPM_SHOWAHEAD="OFF" lpm_width=12 lpm_widthu=10 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" clock data empty q rreq sclr wreq INTENDED_DEVICE_FAMILY="Cyclone V"
//VERSION_BEGIN 21.1 cbx_altdpram 2021:10:21:11:03:22:SJ cbx_altera_counter 2021:10:21:11:03:22:SJ cbx_altera_syncram 2021:10:21:11:03:22:SJ cbx_altera_syncram_nd_impl 2021:10:21:11:03:22:SJ cbx_altsyncram 2021:10:21:11:03:22:SJ cbx_cycloneii 2021:10:21:11:03:22:SJ cbx_fifo_common 2021:10:21:11:03:22:SJ cbx_lpm_add_sub 2021:10:21:11:03:22:SJ cbx_lpm_compare 2021:10:21:11:03:21:SJ cbx_lpm_counter 2021:10:21:11:03:21:SJ cbx_lpm_decode 2021:10:21:11:03:21:SJ cbx_lpm_mux 2021:10:21:11:03:22:SJ cbx_mgl 2021:10:21:11:03:46:SJ cbx_nadder 2021:10:21:11:03:22:SJ cbx_scfifo 2021:10:21:11:03:22:SJ cbx_stratix 2021:10:21:11:03:22:SJ cbx_stratixii 2021:10:21:11:03:22:SJ cbx_stratixiii 2021:10:21:11:03:22:SJ cbx_stratixv 2021:10:21:11:03:22:SJ cbx_util_mgl 2021:10:21:11:03:22:SJ  VERSION_END


//a_fefifo ALLOW_RWCYCLE_WHEN_FULL="OFF" LPM_NUMWORDS=1024 lpm_widthad=10 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" aclr clock empty full rreq sclr wreq
...
endmodule //INPUT_FIFO_cntr

//synthesis_resources = lut 10 reg 12 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INPUT_FIFO_a_fefifo
	( 
	aclr,
	clock,
	empty,
...
endmodule //INPUT_FIFO_altsyncram
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //INPUT_FIFO_cntr1

//synthesis_resources = lut 30 M10K 2 reg 32 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INPUT_FIFO_a_dpfifo
	( 
	clock,
	data,
	empty,
...
`endif
	...
	INPUT_FIFO_a_fefifo   fifo_state
	( 
	.aclr(aclr),
	.clock(clock),
...
endmodule //INPUT_FIFO_a_dpfifo

//synthesis_resources = lut 30 M10K 2 reg 32 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INPUT_FIFO_scfifo
	( 
	clock,
	data,
	empty,
...
module INPUT_FIFO (
	...
	INPUT_FIFO_scfifo	INPUT_FIFO_scfifo_component (
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
				.wrreq (wrreq),
