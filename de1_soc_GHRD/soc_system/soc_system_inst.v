	soc_system u0 (
		...
		.fifo_in_csr_address                   (<connected-to-fifo_in_csr_address>),                   //                    fifo_in_csr.address
		.fifo_in_csr_read                      (<connected-to-fifo_in_csr_read>),                      //                               .read
		.fifo_in_csr_writedata                 (<connected-to-fifo_in_csr_writedata>),                 //                               .writedata
		.fifo_in_csr_write                     (<connected-to-fifo_in_csr_write>),                     //                               .write
		.fifo_in_csr_readdata                  (<connected-to-fifo_in_csr_readdata>),                  //                               .readdata
		...
		.fifo_reset_in_reset_n                 (<connected-to-fifo_reset_in_reset_n>)                  //                  fifo_reset_in.reset_n
	);
