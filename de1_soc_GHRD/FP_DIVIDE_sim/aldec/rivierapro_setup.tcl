...
# ACDS 21.1 842 win32 2024.06.02.17:23:58
# ----------------------------------------
...
# ----------------------------------------
# If FP_DIVIDE is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/FP_DIVIDE_memoryC0_uid146_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/FP_DIVIDE_memoryC0_uid147_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/FP_DIVIDE_memoryC1_uid150_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/FP_DIVIDE_memoryC1_uid151_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/FP_DIVIDE_memoryC2_uid154_invTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FP_DIVIDE.vo"
}
