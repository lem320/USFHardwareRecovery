...
# ACDS 21.1 842 win32 2024.05.12.21:51:17
# ----------------------------------------
...
# ----------------------------------------
# If FIXED_TO_FP is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "FIXED_TO_FP"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIXED_TO_FP.vo"
}
