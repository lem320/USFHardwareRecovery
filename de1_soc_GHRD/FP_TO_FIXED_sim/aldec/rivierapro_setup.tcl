...
# ACDS 21.1 842 win32 2024.05.12.22:30:27
# ----------------------------------------
...
# ----------------------------------------
# If FP_TO_FIXED is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "FP_TO_FIXED"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FP_TO_FIXED.vo"
}
