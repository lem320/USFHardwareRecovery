...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/FP_LOG_memoryC0_uid134_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/FP_LOG_memoryC0_uid135_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/FP_LOG_memoryC1_uid138_lnTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/FP_LOG_memoryC2_uid142_lnTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FP_LOG.vo"
fi
