...
# ACDS 21.1 842 win32 2024.02.27.15:25:34
# ----------------------------------------
...
# ----------------------------------------
# If FP_LOG is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/FP_LOG_memoryC0_uid134_lnTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/FP_LOG_memoryC0_uid135_lnTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/FP_LOG_memoryC1_uid138_lnTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/FP_LOG_memoryC2_uid142_lnTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FP_LOG.vo"
}
